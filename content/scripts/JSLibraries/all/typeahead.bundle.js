...
(function ($) {
  ...
  var Dropdown = (function () {
    ...
    _.mixin(Dropdown.prototype, EventEmitter, {
      ...
      _onSuggestionMouseLeave: function onSuggestionMouseLeave() {
        this._removeCursor();
        this._setCursor(this._getSuggestions().first(), true); // added
      },
      ...
      close: function close() {
        if (this.isOpen) {
          this.isOpen = false;
          this.trigger("suggestionClicked", this._getCursor());
          this._removeCursor();
          this._hide();
          this.trigger("closed");
        }
  ...
  var Typeahead = (function () {
    ...
    _.mixin(Typeahead.prototype, {
      ...
      //changed:if autoselect==true autocomplete with selected or first suggestion on outside dropdown click
      _onBlurred: function onBlurred() {
        var datum, topSuggestionDatum;
        topSuggestionDatum = this.dropdown.getDatumForTopSuggestion();
        if (this.autoselect && (datum = this.dropdown.getDatumForCursor())) {
          this._select(datum);
